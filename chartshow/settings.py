# Django settings for chartshow project.
...
SECRET_KEY = 'k#904$3yb8ad(%+pe9e**!lmcat79r1uy7q#_(&e*9*0skpob5'
...
ROOT_URLCONF = 'chartshow.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'chartshow.wsgi.application'
